      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-md">
        ...
        <form className="space-y-6" action={login}>
          ...
          <div className="flex gap-4">
            ...
            <button
              formAction={signup}
              className="flex-1 bg-gradient-to-r from-green-400 to-green-600 text-white py-2 px-4 rounded-xl hover:from-green-500 hover:to-green-700 transition duration-300 font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
              Sign up
            </button>
          </div>
